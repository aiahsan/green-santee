...
export default ({stepcount,setshownav,shownav,variant})=>{
    ...
    return shownav==true? <div className="overlay">
        
        <div className="sidebar sidebar-overlay">
        <div className="d-flex justify-content-end mb-3" onClick={()=>setshownav(false)}>
            <Icon name="cross"/> 
        </div>
    ...
    </div>:  variant&&true?<></>:   <div className="sidebar sidebar-hide">
       <div >
