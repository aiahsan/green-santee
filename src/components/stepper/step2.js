    ...
    <div className='stepper'>
      ...
      <div className='flex-broke mt-4'>
        <div className='w-100 mr-4 '>
          <Select label='Votre civilité' value='Monsieur' />
        </div>

        <div className='mr-4 w-100'>
          <Textbox label='Nom' value='Kruger' />
        </div>
        <div className='mr-4 w-100'>
          <Textbox label='Prénom' value='Erwin' />
        </div>
      </div>
      <div className='flex-broke mt-4'>
        <div className='mr-4 text-postal2'>
          <Textbox label='Fonction' value='Président' />
        </div>
        <div className='mr-4 w-100'>
          <Textbox label='Adresse Mail' value='thomas@green-sante.fr' />
        </div>
      </div>
      ...
      <div className='flex-broke mt-4'>
        ...
        <div className='mr-4 text-postal'>
      ...
      <div className='flex-broke mt-4'>
        ...
        <div className='text-postal2 mr-4 '>
          <Select label='Pays' value='France' />
        </div>
      </div>
