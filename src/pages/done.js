...
export default ({ isScroll }) => {
  ...
  return (
    <div className='step-done'>
      ...
      <div className={`${isScroll && true ? 'pt-118' : ''}`}>
        <div className=''>
          <div className='done-inner '>
            ...
            <p className='m-0'>
              ...
              nous confiant cette étude.
            </p>
            <p className='done-innertext-cst'>
              Nous vous ferons un retour sous 72 heures pour vous annoncer si
              votre demande a été accordé ou non. Une fois la demande obtenu,
              les informations vous seront envoyé sur l’adresse mail de
              l’assuré.
            </p>
